...
export class DeleteModal extends Component {
    ...
    render() {
        return (
            <div>
                <div
                    className={!this.props.open ? "overflow-y-auto overflow-x-hidden fixed flex content-center items-center bg-transparent backdrop-contrast-50 right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" : "hidden flex content-center items-center bg-transparent backdrop-contrast-50 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"}>
                    <div className="relative px-4 w-full max-w-md h-full md:h-auto ">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-6 pt-0 text-center">
                                ...
                                <button onClick={() => this.props.trigger()} type="button"
